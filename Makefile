...
fuzz:
	$(GO) test -fuzz='^FuzzKVEncoding$$' -fuzztime=30s -timeout=5m ./internal/kvstore/...
	$(GO) test -fuzz='^FuzzKVEncodingBytes$$' -fuzztime=30s -timeout=5m ./internal/kvstore/...
	$(GO) test -fuzz='^FuzzKVOperations$$' -fuzztime=30s -timeout=5m ./internal/kvstore/...
